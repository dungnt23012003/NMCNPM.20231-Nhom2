...
//        String url = "jdbc:sqlserver://LAPTOP-OBVO3M5Q\\CSDL:1433;databaseName=QUAN_LY_NHAN_KHAU;integratedSecurity=true;encrypt=true;trustServerCertificate=true";
        String url = "jdbc:sqlserver://;serverName=192.168.1.5;port=1433;databaseName=QUAN_LY_NHAN_KHAU;authenticationScheme=NTLM;encrypt=true;trustServerCertificate=true";
